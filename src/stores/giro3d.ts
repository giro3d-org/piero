...
export const useGiro3dStore = defineStore('giro3d', () => {
    ...
    function getDefaultCameraPosition(): Coordinates {
        ...
        if (Array.isArray(conf)) {
            console.warn('Configuration is using an array for camera.position, you should switch to an object; see https://gitlab.com/giro3d/giro3d-sample-application/-/issues/24 for more information');
    ...
    function getDefaultBasemapExtent(crs: string) {
        ...
        if (Array.isArray(center)) {
            console.warn('Configuration is using an array for basemap.center, you should switch to an object; see https://gitlab.com/giro3d/giro3d-sample-application/-/issues/24 for more information');
