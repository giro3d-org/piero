...
export const isCityJSONPickResult = (obj: any): obj is CityJSONPickResult => obj?.isCityJSONPickResult;
...
export default class CityJSONEntity
    ...
    pickFeaturesFrom(pickedResult: CityJSONPickResult): CityJSONFeature[] {
        ...
        const cityjsonInfo = object.resolveIntersectionInfo(pickedResult) as CityJSONIntersectionInfo;
