...
<div align="center">
  ...
  <a href="https://www.npmjs.com/package/@giro3d/piero-plugin-obj"><img alt="NPMJS latest package badge" src="https://img.shields.io/npm/v/@giro3d/piero-plugin-obj?color=blue"></a>
  <a href="https://matrix.to/#/#giro3d:matrix.org"><img src="https://img.shields.io/matrix/giro3d:matrix.org" alt="Matrix chat"></a>
</div>

## `piero-plugin-obj`

Plugin for `@giro3d/piero` to add support for OBJ datasets.

## Getting started

Register the `OBJLoader` module when starting the app:
